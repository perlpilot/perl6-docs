...
A leading C<!> indicates a negative zero-width assertion.
A leading C<?> indicates a positive zero-width assertion.
A leading C<.> indicates to not capture the value in to the data structure of C<$/>
