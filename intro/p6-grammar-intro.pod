...
Any of the named regex within the block "belong" to the grammar.  When
they are mentioned within other named regex, Perl will first look within
the grammar for a regex with the appropriate name.

Below is a grammar for ...
...
A grammar is really just a funny kind of class. 
...
In Perl 6, the curly braces are consistently used to denote and executable
...
succeeds or fails, it still outputs "hi" 3 times.
